...
sealed class BackgroundBlurEvent {
    ...
    object ShowSaveSuccess : BackgroundBlurEvent() // Event for save success
    object HideSaveSuccess : BackgroundBlurEvent() // Event to hide the save success bottom sheet
}