package com.thezayin.dslrblur.feature.background.data.segmentation
        ...
        withContext(Dispatchers.Default) {
            try {
                if (originalBitmap.width <= 0 || originalBitmap.height <= 0) {
                    Timber.tag(TAG).e("Invalid bitmap dimensions: ${originalBitmap.width}x${originalBitmap.height}")
